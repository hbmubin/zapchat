...
const BottomNav = () => {
    ...
    return (
        <div className="bg-[#160721] grid grid-cols-3 justify-around py-4 nav-top-shadow">
            ...
            <button className="flex items-center justify-center default-btn" onClick={()=>setSideView('peoples')}> <div className={`${sideView == 'groups' ? 'bg-violet-200 bg-opacity-10 nav-btn-shadow rounded-full p-1`' : 'text-neutral-600 hover:text-neutral-100'} duration-200`}><MdGroups size={20} /></div></button>
        </div>
    );
};
